document.addEventListener("DOMContentLoaded", function() {
    try{
        ...
        // example posts data for rendering posts 
        const posts = [
            {
                username: "sayareddy",
                ...
                comments: [
                    ...
                    { username: "user2", text: "uiewurheui hir ewhrew hrioew hfieh wifhi owfhwi ehfihew iofh iwhifoh ewihfio wehfie wifhie wofhie whfhiew fhiewi iofhiew ifhiewo hfewh fe wioh iofewo qfhe whfhwe ifhiow hhf" },
                    { username: "user3", text: "Great pic!" },
                    { username: "user2", text: "Nice post!" },
                    { username: "user3", text: "Great pic!" },
                ]
        ...
        posts.forEach(post => {
            ...
            postElement.innerHTML = `
                ...
                <div class="post-details">
                    ...
                    <div class="comments">
                        ${post.comments.map(comment => `<div class="comment-item"><strong class="comment-user">${comment.username}</strong>: ${comment.text}</div>`).join("")}
        ...
        console.error("some error in feed page")
    }
});
